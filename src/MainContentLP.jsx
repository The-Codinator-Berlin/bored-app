...
function MainContentLP() {
  return (
    <div className="flexMainContent">
      <div className="mainContentDiv text-sky-500 font-poppins font-normal text-center md:font-bold text-base">There's no need to be bored <br></br>wheen you can cure <br></br>your boredom!</div>
